...
class TestTagsEdgeBranches:
    ...
    def test_tag_session_and_subcommand_edges(self, test_db, monkeypatch, capsys):
        ...
        monkeypatch.setattr("siftd.api.dispatch.execute", lambda op: [SimpleNamespace(name="x", description=None, conversation_count=0, workspace_count=0, tool_call_count=0, exchange_count=0, prompt_count=0, response_count=0, block_count=0)])
        ...
        monkeypatch.setattr("siftd.api.dispatch.execute", lambda op: [SimpleNamespace(name="abc", description=None, conversation_count=1, workspace_count=0, tool_call_count=0, exchange_count=0, prompt_count=0, response_count=0, block_count=0)])
        assert tags_cli._cmd_tag_list(list_args, Path(test_db)) == 0
    ...
    def test_remaining_list_rename_delete_and_cmd_tag_branches(self, test_db, monkeypatch, capsys):
        ...
        ti = SimpleNamespace(name="t", conversation_count=1, workspace_count=2, tool_call_count=3, exchange_count=4, prompt_count=0, response_count=0, block_count=0)
