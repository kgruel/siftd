...
Ingest with --rebuild-fts flag works:
  ...
  $ HOME=$PRYSK_TEMP XDG_DATA_HOME=$PRYSK_TEMP/data XDG_CONFIG_HOME=$PRYSK_TEMP/config siftd --db $PRYSK_TEMP/fts.db ingest --rebuild-fts -v 2>&1 | grep "Rebuilding FTS"
