...
if TYPE_CHECKING:
    from tbd.output.formatters import OutputFormatter
...
def load_entrypoint_formatters() -> dict[str, ModuleType]:
    """Discover formatters registered via the 'tbd.formatters' entry point group."""
    formatters: dict[str, ModuleType] = {}
    eps = importlib.metadata.entry_points(group="tbd.formatters")
...
class FormatterRegistry:
    ...
    def __init__(self, dropin_path: Path | None = None):
        from tbd.paths import formatters_dir
