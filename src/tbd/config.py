"""User configuration management for tbd.

Config file location: ~/.config/tbd/config.toml
...
from tbd.paths import config_dir, config_file
...
def get_ask_defaults() -> dict:
    """Get default values for 'tbd ask' command from config.
