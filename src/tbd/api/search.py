...
from tbd.search import SearchResult, hybrid_search
...
def build_index(
    *,
    ...
    Thin wrapper over tbd.embeddings.build_embeddings_index that returns
    ...
    """
    from tbd.embeddings import build_embeddings_index
