...
class HtmlEmitter:
    ...
    def __init__(self, target_event_id: str | None = None) -> None:
    ...
    def tool_content(
        ...
        *,
        ...
        if has_content:
            parts = [f'<details class="tool-call{status_css}{anchor_cls}"{anchor_attrs}>']
            parts.append(
                f'<summary>'
            ...
            parts = [f'<div class="tool-call{status_css}{anchor_cls}"{anchor_attrs}>']
