...
def create_app(
    *,
    ...
    route_handlers: list[Any] = [
        ...
        ui_tags, ui_workspaces, ui_workspace_detail, ui_workspace_pin, ui_view_stub,
        ui_find, ui_meta, ui_query, ui_find_context,
        ui_tag, ui_tag_pin, ui_tags_suggest, ui_export, ui_block_raw,
        static_router,
    ]
