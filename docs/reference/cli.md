...
usage: siftd search [-h] [-w SUBSTR] [-m NAME] [--since DATE] [--before DATE]
                    ...
                    [--view VIEW] [--refs [FILES]] [--mode ENGINE]
                    [--recall N] [--threshold SCORE] [--raw-fts]
...
search engine:
  --mode ENGINE         Search engine: auto (default), fts, semantic, or
                        hybrid. auto picks hybrid when embeddings are
                        installed, else fts.
