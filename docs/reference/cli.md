...
output:
  -n LIMIT, --limit LIMIT
                        Number of conversations to show (0=all, default: 10)
...
options:
  ...
  -n N, --limit N       Maximum number of sessions to list (default: 10)
