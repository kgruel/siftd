...
**FTS5 full-text search** — use `siftd search --mode fts` instead:
```bash
siftd search --mode fts "error handling"
siftd search --mode fts "error handling" -w myproject    # FTS5 + workspace
```
...
siftd search --mode fts "migration" -w myproject
