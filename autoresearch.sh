...
# API sessions coverage efficiency benchmark

INCLUDE_ARGS="--cov=siftd.api.sessions"
TARGET_FILE="src/siftd/api/sessions.py"
TEST_FILES="tests/test_api_sessions_edges.py"
